...
export const deletePhotoRequest = createAction('[Photos] Delete Request', props<{ photoId: string }>());
export const deletePhotoSuccess = createAction('[Photos] Delete Success');
export const deletePhotoFailure = createAction('[Photos] Delete Failure', props<{ error: string }>());
